(function () {
	...
	Player.prototype.updateBoard = function() {
		...
		document.getElementById("earning").innerHTML = "MONEY IN THE POT $" + player.getWager() + " X2";
		$('#earning').removeClass();
	...
	function getWinner() {
		...
		if(pscore > dscore) {
			if(pscore === 21 && phand.length < 3) {
				...
				document.getElementById("earning").innerHTML = "CONGRATULATIONS YOU WON $" + winnings;
				$('#earning').removeClass();
				...
				document.getElementById("earning").innerHTML = "Sorry... You lost $" + -winnings ;
				$('#earning').removeClass();
			...
			if(pscore <= 21) {
				if(dscore === 21 && dhand.length < 3 && phand.length > 2) {
					...
					winnings = wager;
					player.setCash(winnings);
					document.getElementById("earning").innerHTML = "It's a tie! No losses or wins" ;
					$('#earning').removeClass();
