...
async function predict() {
    ...
    if (prediction[0].className == "dog" && prediction[0].probability.toFixed(2) > 0.9){
      ...
      labelContainer.childNodes[0].innerHTML = "Hmmm... According to my calculation this is a Bird";
        ...
        labelContainer.childNodes[0].innerHTML = "This person look";
        ...
        labelContainer.childNodes[2].innerHTML = (largest2*100).toFixed(0) + "% " + animal + " feature according to my calculation.";
